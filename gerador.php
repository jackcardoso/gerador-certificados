...
$fileCSV = $dirCSV.basename($_FILES['fileCSV']['name']); 
...
$caminhoCSV = "./plans/";
$caminhoCSV = $caminhoCSV.$_FILES[arquivoCSV][name];
move_uploaded_file($arquivoCSV,$caminhoCSV);
*/
// Image File Upload
/* Diretório para aonde a imagem será salva */
$dirIMG = "backgrounds/"; 
...
while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
    ...
    // -------------------------------------------------------------------
    $html =  str_replace('[nome]',$nome, $texto);
    // -------------------------------------------------------------------
